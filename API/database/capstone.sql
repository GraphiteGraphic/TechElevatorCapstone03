...
INSERT INTO recipes_ingredients (recipe_id, ingredient_id, ingredient_qty, ingredient_unit)
	...
	((select recipe_id from recipes where recipe_name='Pesto Lasagna Rolls'), (select ingredient_id from ingredients where ingredient_name = 'unsalted butter'),2, 'tablespoons'),
	((select recipe_id from recipes where recipe_name='Pesto Lasagna Rolls'), (select ingredient_id from ingredients where ingredient_name = 'all-purpose flour'),2, 'tablespoons'),
	((select recipe_id from recipes where recipe_name='Pesto Lasagna Rolls'), (select ingredient_id from ingredients where ingredient_name = 'whole milk'),1.5, 'cups'),
	((select recipe_id from recipes where recipe_name='Pesto Lasagna Rolls'), (select ingredient_id from ingredients where ingredient_name = 'egg'),1, 'large'),
	((select recipe_id from recipes where recipe_name='Pesto Lasagna Rolls'), (select ingredient_id from ingredients where ingredient_name = 'whole milk ricotta'),2, 'cups'),
	((select recipe_id from recipes where recipe_name='Pesto Lasagna Rolls'), (select ingredient_id from ingredients where ingredient_name = 'frozen chopped spinach, thawed and squeezed dry'),1, '10-ounce package'),
	((select recipe_id from recipes where recipe_name='Pesto Lasagna Rolls'), (select ingredient_id from ingredients where ingredient_name = 'mozzerella cheese'),2.5, 'cups'),
	((select recipe_id from recipes where recipe_name='Pesto Lasagna Rolls'), (select ingredient_id from ingredients where ingredient_name = 'parmesan cheese'),0.75, 'cups'),
	...
	((select recipe_id from recipes where recipe_name='Pesto Lasagna Rolls'), (select ingredient_id from ingredients where ingredient_name = 'extra-virgin olive oil'),1, 'tablespoon'),
	...
	((select recipe_id from recipes where recipe_name='Chicken Thighs with Creamy Mustard Sauce'), (select ingredient_id from ingredients where ingredient_name = 'olive oil'),1, 'ounce'),
	...
	((select recipe_id from recipes where recipe_name='Chicken Thighs with Creamy Mustard Sauce'), (select ingredient_id from ingredients where ingredient_name = 'dry white wine'),2, 'tablespoons'),
	((select recipe_id from recipes where recipe_name='Chicken Thighs with Creamy Mustard Sauce'), (select ingredient_id from ingredients where ingredient_name = 'creme fraiche'),8, 'ounces'),
	((select recipe_id from recipes where recipe_name='Chicken Thighs with Creamy Mustard Sauce'), (select ingredient_id from ingredients where ingredient_name = 'dijon mustard'),1, 'tablespoon'),
	((select recipe_id from recipes where recipe_name='Chicken Thighs with Creamy Mustard Sauce'), (select ingredient_id from ingredients where ingredient_name = 'whole-grain mustard'),1, 'teaspoon'),
	((select recipe_id from recipes where recipe_name='Chicken Thighs with Creamy Mustard Sauce'), (select ingredient_id from ingredients where ingredient_name = 'parsley'),1, 'tablespoon chopped'),
	...
	(2, (select ingredient_id from ingredients where ingredient_name = 'dark brown sugar'),2, 'cups'),
	(2, (select ingredient_id from ingredients where ingredient_name = 'butter'),2, 'sticks'),
	(2, (select ingredient_id from ingredients where ingredient_name = 'vanilla extract'),2, 'teaspoons'),
	(2, (select ingredient_id from ingredients where ingredient_name = 'eggs'),2, ''),
	(2, (select ingredient_id from ingredients where ingredient_name = 'all-purpose flour'),1.5, 'cups'),
	(2, (select ingredient_id from ingredients where ingredient_name = 'salt'),1, 'teaspoon'),
	(2, (select ingredient_id from ingredients where ingredient_name = 'baking soda'),0.5, 'teaspoon'),
	(2, (select ingredient_id from ingredients where ingredient_name = 'old-fashioned oats'),3, 'cups'),
	(1, 5, 2, 'Oz'),
	(1, 6, 2, 'Oz'),
	(1,7, 2, 'Slices'),
	...
	(3,(select ingredient_id from ingredients where ingredient_name = 'eggs'),8,'whole'),
